    ...
    >
      <motion.div className="relative" variants={itemVariants}>
        <p className="font-mono text-xs uppercase text-[var(--color-muted)]">
          AI & Full Stack Engineer / {personal.location}
        </p>
          ...
          {personal.name.split(" ").map((word, index) => (
            <span className="block overflow-hidden" key={word}>
              <motion.span
                className={
                  index === 1
                    ? "font-display inline-block text-[var(--accent-red)]"
                    : "inline-block"
                }
        ...
        <div className="mt-8 max-w-4xl border-l border-[var(--color-line)] pl-5">
          <p className="text-lg leading-8 text-[var(--color-muted-strong)]">
            {personal.tagline}
          </p>
      ...
      <motion.aside className="grid gap-4" variants={itemVariants}>
        <div className="shine-surface glass-shell interactive-card rounded-2xl p-5">
          ...
          <p className="mt-5 font-mono text-sm leading-7 text-[var(--color-muted-strong)]">
            <span className="text-[var(--accent-red)]">role:</span>{" "}
            {primaryExperience.role}
            <br />
            <span className="text-[var(--accent-red)]">stack:</span>{" "}
            {primarySkills.join(", ")}
          </p>
        </div>
        <div className="shine-surface interactive-card rounded-2xl border border-[var(--color-line)] bg-[var(--color-panel)] p-5">
          ...
          <p className="mt-3 font-mono text-5xl leading-none text-[var(--accent-red)]">
            {stats[0].value}
          </p>
